...
window.categories = [
   ...
   */
  { id: "GMG-LPT", description: "Gaming Laptops" },
  { id: "GMG-PCS", description: "Gaming Computers" },
  { id: "OFC-LPT", description: "Office Laptops" },
  { id: "OFC-PCS", description: "Office Computers" }
];
